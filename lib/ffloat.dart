...
//    }
  ...
  Widget buildFloatContent() {
    ...
    Widget floatContent = Positioned(
      left: (location.dx + areaOffset.dx) < 0
          ? 0
          : (location.dx + areaOffset.dx + areaSize?.width ?? 0.0) > w ? w -
          areaSize?.width ?? 0.0 : location.dx + areaOffset.dx,
